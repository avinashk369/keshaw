...
<html lang="en-US">
  ...
  <nav class="navbar navbar-default navbar-expand-lg fixed-top custom-navbar">
    ...
    <img src="{{asset('public/assets/images/logo.png')}}" class="img-fluid nav-logo-mobile" alt="Company Logo">
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <div class="container">
      	<img src="{{asset('public/assets/images/logo.png')}}" class="img-fluid nav-logo-desktop" alt="Company Logo">
        <ul class="navbar-nav ml-auto nav-right" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
          <li class="nav-item nav-custom-link">
            <a class="nav-link" href="{{url('/')}}">Home <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
          </li>
          <li class="nav-item nav-custom-link">
          ...
          <li class="nav-item nav-custom-link btn btn-demo-small">
            <a class="nav-link" data-toggle="modal" 
                      data-target="#loginModal" >Try for Free <i class="icon ion-ios-arrow-forward icon-mobile"></i></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
          <img src="{{asset('public/assets/images/iphone.png')}}" class="img-fluid" alt="Demo image">
        </div>
  ...
  <section id="marketing">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
            <img src="{{asset('public/assets/images/demo-image.png')}}" class="img-fluid" alt="Demo image">
        </div>
      </div>
    </div>
  </section>
